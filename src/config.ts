...
const HEDERA_TESTNET_ACCOUNT_ID = process.env.MY_ACCOUNT_ID
const HEDERA_TESTNET_ACCOUNT_PRIVATE_KEY = process.env.MY_PRIVATE_KEY

if (HEDERA_TESTNET_ACCOUNT_ID === undefined || HEDERA_TESTNET_ACCOUNT_PRIVATE_KEY === undefined) {
  throw new Error('HEDERA_TESTNET_ACCOUNT_ID and HEDERA_TESTNET_ACCOUNT_PRIVATE_KEY must be set')
}

const envAccount: Account = {
  id: HEDERA_TESTNET_ACCOUNT_ID,
  privateKey: HEDERA_TESTNET_ACCOUNT_PRIVATE_KEY
}
...
export const accounts: Account[] = [envAccount, ...initialAccounts]
